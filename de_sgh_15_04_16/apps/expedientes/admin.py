...
from .models import (Expediente, ExpedienteResolucion, ExpedienteDisposicion,
                     ...
                     ExpedienteLicitacionCompromiso,
                     ExpedienteLicitacionOrdenado, ExpedienteComodato,
...
class ExpedienteComodatoAdmin(admin.ModelAdmin):
    ...
    search_fields = ['expediente']
    ordering = ['expediente']
    list_display = ['id', 'expediente', 'resolucion_contratacion',
                    'numero_contratacion_directa', 'importe',
                    'orden_provision', 'resolucion_pago',
                    'fecha_resolucion_pago', 'solicitante_resolucion_pago'
                    ]
...
class ExpedienteResolucionesVariasAdmin(admin.ModelAdmin):

    search_fields = ['expediente']
    ordering = ['expediente']
    list_display = ['expediente', 'resolucion_pago',
                    'fecha_resolucion_pago', 'observaciones']


class ExpedienteResolucionContratacionAdmin(admin.ModelAdmin):

    search_fields = ['expediente']
    ordering = ['expediente']
    list_display = ['expediente', 'proveedor', 'numero_resolucion',
...
admin.site.register(
    ExpedienteLicitacionCompromiso, ExpedienteLicitacionCompromisoAdmin)
admin.site.register(ExpedienteComodato, ExpedienteComodatoAdmin)
admin.site.register(
    ExpedienteLicitacionOrdenado, ExpedienteLicitacionOrdenadoAdmin)
admin.site.register(
    ExpedienteResolucionesVarias, ExpedienteResolucionesVariasAdmin)
admin.site.register(
    ExpedienteResolucionContratacion, ExpedienteResolucionContratacionAdmin)
