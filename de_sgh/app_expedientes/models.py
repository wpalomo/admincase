...
class Expediente(models.Model):
    ...
    def __str__(self):
        return str(self.letra) + '-' + str(self.numero) + '-' + str(self.anio)
...
class ExpedienteResolucion(models.Model):
    ...
    numero_identificacion_transaccion = models.IntegerField(
        null=True, blank=True)
...
class ExpedienteServicioMedico(models.Model):
    ...
    profesional = models.ForeignKey(
        Empleado, unique=False, related_name='profesional',
        null=True, blank=True)
...
class ExpedienteComodato(models.Model):
    ...
    proveedor = models.ForeignKey(Proveedor, unique=False, null=True, blank=True)
    resolucion_contratacion = models.CharField(null=True, blank=True, max_length=100)
    fecha_resolucion_contratacion = models.DateField(null=True, blank=True)
    ...
    fecha_resolucion_pago = models.DateField(null=True, blank=True)
    solicitante_resolucion_pago = models.ForeignKey(Empleado, unique=False, null=True, blank=True)
    fuente_financiamiento = models.ForeignKey(FuenteFinanciamiento, unique=False, null=True, blank=True)
    observaciones = models.TextField(max_length=None, null=True, blank=True)
